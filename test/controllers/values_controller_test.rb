...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference("Value.count") do
      post values_url, params: { value: { anime_title_id: @value.anime_title_id, user_id: @value.user_id, value: @value.value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { anime_title_id: @value.anime_title_id, user_id: @value.user_id, value: @value.value } }
